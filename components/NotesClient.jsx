                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 focus:outline-none focus:ring"
                    >
                      Cancel
                    </button>
                  </div>
                  ...
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex gap-2 shrink-0">
                      <button
                        ...
                        className="text-blue-500 hover:text-blue-700 text-sm cursor-pointer transition-colors duration-200 font-medium"
                      >
                        Edit
                      </button>
                      <button
                        onClick={() => deleteNote(note._id)}
                        className="text-red-500 hover:text-red-700 text-sm cursor-pointer transition-colors duration-200 font-medium"
                      >
                        Delete
                      </button>
                    </div>
